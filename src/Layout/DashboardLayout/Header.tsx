...
const Header = () => {
  ...
  return (
    <header className="h-16 bg-slate-900 border-b border-slate-800 sticky top-0 z-30 flex items-center">
      <CommonWrapper className="flex items-center justify-between w-full px-6">
        ...
        <div className="relative w-96">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-sm focus:outline-none focus:ring-4 focus:ring-primary-brand/10 transition-all text-white placeholder:text-slate-400"
          />
        </div>
        ...
        <div className="flex items-center gap-4">
          {/* Notifications */}
          <button className="p-2 text-slate-400 hover:bg-slate-800 rounded-full relative transition-colors">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-3 p-1.5 px-3 rounded-full border border-slate-800 bg-slate-800/40 hover:bg-slate-800 transition-all group"
            >
              <div className="text-right hidden sm:block">
                <p className="text-sm font-semibold text-slate-100 leading-none">
                  John Doe
                </p>
                <p className="text-xs text-slate-400 uppercase mt-1 text-left">
                  Admin
                </p>
              </div>

              <div className="relative">
                <div className="w-8 h-8 bg-primary-brand rounded-full flex items-center justify-center text-white font-semibold text-sm border border-slate-700 group-hover:border-primary-brand transition-all">
                  JD
                </div>
                {/* Status Indicator */}
